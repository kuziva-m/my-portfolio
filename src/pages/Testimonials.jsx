...
const BackgroundPattern = () => {
  const icons = [
    ...
    "M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-5 14H9v-2h6v2zm0-5H9v-2h6v2zm0-5H9V6h6v2z",
    "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z",
    "M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm0 2c5.514 0 10 4.486 10 10s-4.486 10-10 10-10-4.486-10-10 4.486-10 10-10zm0-2c-2.66 0-5.18.77-7.23 2.11 3.2 2.05 6.2 5.35 6.2 9.89h2.06c0-4.54 3-7.84 6.2-9.89-2.05-1.34-4.57-2.11-7.23-2.11z",
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          <motion.span
            ...
            className="text-[#ED553B] font-bold tracking-widest text-sm uppercase block mb-3 font-mono"
          >
            // Testimonials
          </motion.span>
          <motion.h2
          ...
          >
            Client{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ED553B] to-[#F6D55C]">
              Feedback
            </span>
          </motion.h2>
        </div>
            ...
            >
              ...
              <div className="flex gap-1 mb-6">
                {[...Array(review.rating)].map((_, i) => (
                  <svg
                    key={i}
                    className="w-4 h-4 text-[#F6D55C] fill-current"
                    viewBox="0 0 20 20"
                  >
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-[#ED553B] text-xs font-bold uppercase tracking-wider font-mono mt-1">
                    {review.platform}
                  </p>
                </div>
